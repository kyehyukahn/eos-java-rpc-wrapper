...
public class PushTransactionRequest {
    ...
    public PushTransactionRequest(String compression, SignedPackedTransaction signedTransaction, List<String> signatures) {
		...
		com.oraclechain.pocketeos.blockchain.chain.SignedTransaction _signedTransaction
		= gson.fromJson(signedTransactionString, com.oraclechain.pocketeos.blockchain.chain.SignedTransaction.class);        

    	//3. make a packedTransaction 
        com.oraclechain.pocketeos.blockchain.chain.PackedTransaction packedTransaction 
        = new com.oraclechain.pocketeos.blockchain.chain.PackedTransaction(_signedTransaction, com.oraclechain.pocketeos.blockchain.chain.PackedTransaction.CompressType.none);
